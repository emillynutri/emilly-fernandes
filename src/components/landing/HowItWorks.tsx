      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <div className="mt-16 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
          {steps.map((s) => (
            <div
              key={s.n}
              className="reveal group relative rounded-2xl border border-navy/10 bg-cream-soft/60 p-8 transition-all hover:-translate-y-1 hover:border-navy/30 hover:shadow-[0_20px_50px_-20px_rgba(4,24,48,0.25)]"
            >
