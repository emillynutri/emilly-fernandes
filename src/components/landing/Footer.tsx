import logoNome from "@/assets/logo-nome-clean.png";
      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-16 lg:grid-cols-[1.4fr_1fr_1fr] lg:px-10">
        ...
        <div>
          ...
          <a
            ...
            className="mt-4 inline-flex items-center gap-2 text-cream transition hover:text-cream/70"
          >
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm">
            ...
            <li>
              <a href="#servicos" className="transition hover:text-cream">
                Acompanhamento
              </a>
            </li>
            <li>
